"""Build the Stage 1b public and private manifests."""
...
from blind_audit.stage1b_benchmark import build_manifests  # noqa: E402


ROOT = Path(__file__).resolve().parents[1]
DEFAULT_PUBLIC = ROOT / "blind_audit" / "manifests" / "stage1b_public.json"
DEFAULT_PRIVATE = ROOT / "blind_audit" / "private" / "stage1b_truth.json"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Development only; invalid for the final frozen manifest.",
    )
        ...
        json.dumps(
            {
                ...
                "endpoint_count": public["endpoint_count"],
                "case_count": public["case_count"],
                "topic_bank_count": len(public["topic_bank"]),
                "hidden_evaluation": public["hidden_evaluation"],
                "implementation_files": len(
                    public["implementation_sha256"]
                ),
            },
            indent=2,
        )
