"""Clean Kaggle FP16 replication, shard A, for Stage 1b contrastive collection."""
...
OUTPUT = WORKING / "stage1b_contrastive_kaggle_fp16_shard_a.json"
REPORT = WORKING / "stage1b_kaggle_fp16_shard_a_runtime.json"
